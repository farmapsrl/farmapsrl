...
const icone = {
  ...
  "Glicemia": (
    <S>
      <path d="M12 2c-5.33 7.33-8 11.67-8 14a8 8 0 0 0 16 0c0-2.33-2.67-6.67-8-14z"/>
    </S>
  ),
  "Profilo Lipidico Completo": (
    <S>
      <path d="M9 3h6"/>
      <path d="M8 3v12a4 4 0 0 0 8 0V3"/>
      <line x1="8" y1="9" x2="16" y2="9"/>
    </S>
  ),
  "Emoglobina Glicata": (
    <S>
      <path d="M5.64 17A9 9 0 0 1 12 3a9 9 0 0 1 6.36 14"/>
      <line x1="12" y1="12" x2="14.5" y2="7"/>
      <circle cx="12" cy="12" r="2"/>
    </S>
  ),
  "Tampone Streptococco e Covid": (
    <S>
  ...
  "Breath Test Helicobacter Pylori": (
    <S>
      <path d="M4 12c0-3 2-5 5-4s3 5 6 5 5-2 5-5"/>
      <path d="M4 12c0 3 2 5 5 4s3-5 6-5 5 2 5 5"/>
    </S>
  ),
  "Vaccinazione Anti-Pneumococcica": (
    <S>
      <path d="M19 3l2 2-9.5 9.5-4-4z"/>
      <path d="M5 15L3 21l6-2z"/>
  ...
  "Laboratorio Preparazione Galenica": (
    <S>
  ...
  "Foratura Lobi": (
    <S>
      <path d="M6 12a6 6 0 0 1 12 0c0 4-3 7-4 8a2 2 0 0 1-4 0"/>
      <circle cx="15" cy="14" r="1" fill="#3B6D11" stroke="none"/>
    </S>
  ),
  "Foratura Lobi e Naso": (
    <S>
      <path d="M6 12a6 6 0 0 1 12 0c0 4-3 7-4 8a2 2 0 0 1-4 0"/>
      <circle cx="15" cy="14" r="1" fill="#3B6D11" stroke="none"/>
    </S>
  ),
  "Noleggio Ausili e Dispositivi Medici": (
    <S>
  ...
  "Deblistering Farmaci": (
    <S>
      <rect x="2" y="9" width="20" height="6" rx="3"/>
      <line x1="12" y1="9" x2="12" y2="15"/>
      <circle cx="7" cy="12" r="1" fill="#3B6D11" stroke="none"/>
    </S>
  ),
  "Attivazione SPID": (
    <S>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
                {cat.servizi.map((nome) => (
                  <div
                    ...
                    style={{ background: "#fff", border: "1px solid #eee", borderRadius: 14, padding: "1.25rem", cursor: "pointer", display: "flex", alignItems: "center", gap: 14 }}
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 500, marginBottom: 6, lineHeight: 1.3 }}>{nome}</div>
                      <span style={{ fontSize: 12, color: "#3B6D11", fontWeight: 500 }}>Scopri di più →</span>
                    </div>
                  </div>
                ))}
              </div>
