...
"Consulenza Fisioterapista": "La farmacia ospita un fisioterapista professionista per consulenze e trattamenti riabilitativi.\n\nPer prenotare un appuntamento contatta direttamente la farmacia.",
  "INR": "L'INR (International Normalized Ratio) misura il tempo di coagulazione del sangue. È un esame indispensabile per i pazienti in terapia anticoagulante orale con warfarin o acenocumarolo, che devono monitorarlo regolarmente per mantenere il dosaggio corretto ed evitare rischi di emorragie o trombosi.\n\nIl test viene eseguito tramite un semplice prelievo capillare con risultato immediato, senza bisogno di recarsi in ospedale.",
  "PSA": "Il PSA (Prostate-Specific Antigen) è un marcatore proteico prodotto dalla prostata, utile per il monitoraggio della salute prostatica e come supporto alla diagnosi precoce di alterazioni della ghiandola, incluso il carcinoma prostatico.\n\nIl test viene eseguito tramite prelievo capillare. Si consiglia di consultare il proprio medico per valutare l'indicazione all'esame e per l'interpretazione del risultato.",
  "Cannabis Terapeutica": "Il nostro laboratorio galenico allestisce preparazioni magistrali a base di cannabis terapeutica su prescrizione medica, nei dosaggi indicati dal medico prescrittore.\n\nLa cannabis terapeutica è indicata in diverse patologie come il dolore cronico, la spasticità, la nausea da chemioterapia e alcune forme di epilessia farmacoresistente. L'accesso è riservato ai pazienti con ricetta medica non ripetibile.\n\nContattaci per informazioni sui tempi di preparazione e sulle modalità di ritiro.",
  "Proteina C Reattiva (PCR)": "La Proteina C Reattiva è un marcatore di infiammazione prodotto dal fegato in risposta a infezioni batteriche, virali o infiammazioni di vario tipo. Il suo dosaggio è utile per valutare la presenza e l'intensità di uno stato infiammatorio acuto, distinguere infezioni batteriche da virali e monitorare l'andamento di malattie infiammatorie croniche.\n\nIl test viene eseguito tramite un semplice prelievo capillare. Contattaci per informazioni su prenotazione e modalità.",
  "TSH": "Il TSH (Thyroid Stimulating Hormone) è l'ormone ipofisario che regola l'attività della tiroide. La sua misurazione è il primo esame per valutare la funzione tiroidea e per monitorare chi è già in terapia con levotiroxina.\n\nIl test viene eseguito tramite un semplice prelievo capillare. Contattaci per informazioni su prenotazione e modalità.",
  "Ferritina": "La ferritina è la principale proteina di deposito del ferro nell'organismo. Il suo dosaggio permette di valutare le riserve di ferro ed è utile per diagnosticare o monitorare condizioni come l'anemia sideropenica, la carenza di ferro latente o, al contrario, un eccesso di ferro.\n\nIl test viene eseguito tramite un semplice prelievo capillare. Contattaci per informazioni.",
};
